...
class User(Base):
    ...
    notify_relationship_request = Column(Boolean, default=True)  # Receive notifications for family relationship requests
    ...
    media_comment_reactions = relationship("MediaCommentReaction", back_populates="user", cascade="all, delete-orphan")
