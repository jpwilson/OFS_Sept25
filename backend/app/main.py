...
from .api import auth, events, users, comments, likes, upload, locations, geocoding, custom_groups, share_links, stripe_api, email_api, invitations, media_engagement, tag_profiles, event_tags, relationships, feedback
...
app.include_router(custom_groups.router, prefix=f"{settings.API_V1_STR}/custom-groups", tags=["custom-groups"])
app.include_router(share_links.router, prefix=settings.API_V1_STR, tags=["share-links"])
app.include_router(stripe_api.router, prefix=settings.API_V1_STR, tags=["stripe"])
app.include_router(email_api.router, prefix=settings.API_V1_STR, tags=["email"])
app.include_router(invitations.router, prefix=settings.API_V1_STR, tags=["invitations"])
app.include_router(media_engagement.router, prefix=settings.API_V1_STR, tags=["media-engagement"])
app.include_router(tag_profiles.router, prefix=settings.API_V1_STR, tags=["tag-profiles"])
app.include_router(tag_profiles.claims_router, prefix=settings.API_V1_STR, tags=["tag-profile-claims"])
